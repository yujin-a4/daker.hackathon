...
export const hackathons: Hackathon[] = [
  ...
  // --- UPCOMING (4) ---
  {
    ...
    period: { timezone: 'Asia/Seoul', submissionDeadlineAt: '2026-05-01T23:59:59+09:00', endAt: '2026-05-15T14:00:00+09:00' },
    participantCount: 0,
    prizeTotal: '300만원',
  ...
  },
  {
    ...
    period: { timezone: 'Asia/Seoul', submissionDeadlineAt: '2026-05-10T23:59:59+09:00', endAt: '2026-05-25T14:00:00+09:00' },
    participantCount: 0,
    prizeTotal: '200만원',
  ...
  },
  {
    ...
    period: { timezone: 'Asia/Seoul', submissionDeadlineAt: '2026-06-01T23:59:59+09:00', endAt: '2026-06-10T15:00:00+09:00' },
    participantCount: 0,
    prizeTotal: '500만원',
  ...
  },
  {
    ...
    period: { timezone: 'Asia/Seoul', submissionDeadlineAt: '2026-06-15T23:59:59+09:00', endAt: '2026-06-30T18:00:00+09:00' },
    participantCount: 0,
    prizeTotal: '600만원',
...
export const hackathonDetails: HackathonDetail[] = [
  ...
  // --- UPCOMING (4) ---
  {
    ...
    sections: {
      overview: {
        summary: '탈중앙화 금융(DeFi) 서비스를 Web3 기술로 구현하는 실전 해커톤입니다. 스마트 컨트랙트 설계부터 실제 DApp 프로토타입까지 완성하세요. Ethereum/Polygon 네트워크를 활용한 혁신적인 금융 솔루션을 기대합니다.',
        teamPolicy: { allowSolo: true, maxTeamSize: 5 },
      },
      info: { notice: ['스마트 컨트랙트 구현 필수', 'Ethereum/Polygon 네트워크 지원', '최종 제출물은 오픈소스로 공개 필수'], links: { rules: '#', faq: '#' } },
      eval: { metricName: '금융 가치', description: 'Web3 솔루션의 혁신성과 실현 가능성, 코드 품질을 종합 평가합니다.', scoreSource: 'auto' },
      schedule: {
        timezone: 'Asia/Seoul',
        milestones: [
          { name: '대회 시작 및 팀 모집', at: '2026-04-20T10:00:00+09:00', step: 0 },
          { name: '1단계: DeFi 아이디어 기획서 제출', at: '2026-05-01T23:59:59+09:00', type: 'submission', step: 1, itemKey: 'idea', galleryEnabled: false },
          { name: '2단계: DApp 프로토타입 제출', at: '2026-05-10T23:59:59+09:00', type: 'submission', step: 2, itemKey: 'dapp', galleryEnabled: false },
          { name: '프로젝트 공개 및 커뮤니티 검토', at: '2026-05-11T10:00:00+09:00', type: 'voting', step: 3, votingEnabled: true, galleryEnabled: true },
          { name: '최종 심사 및 결과 발표', at: '2026-05-15T14:00:00+09:00', type: 'result', step: 4 },
        ],
      },
      prize: { items: [{ place: '1등', amountKRW: 1500000 }, { place: '2등', amountKRW: 900000 }, { place: '3등', amountKRW: 600000 }] },
      teams: { campEnabled: true, listUrl: '#' },
      submit: {
        allowedArtifactTypes: ['url', 'pdf'],
        submissionUrl: '#',
        guide: ['아이디어 기획서와 DApp 프로토타입 링크를 단계별로 제출하세요.'],
        submissionItems: [
          { key: 'idea', title: 'DeFi 아이디어 기획서 (PDF)', format: 'PDF', deadline: '2026-05-01T23:59:59+09:00' },
          { key: 'dapp', title: 'DApp 프로토타입 링크 (GitHub/Vercel)', format: 'URL', deadline: '2026-05-10T23:59:59+09:00', isGalleryTarget: true },
        ],
      },
      leaderboard: { publicLeaderboardUrl: '#', note: '커뮤니티 검토 기간 중 갤러리는 블라인드 처리됩니다.' },
    },
  },
  {
    slug: 'lowcode-nocode-2026',
    ...
    sections: {
      overview: {
        summary: '비개발자도 참가할 수 있는 업무 자동화 해커톤입니다. Notion, Airtable, Zapier, Make 등 노코드 툴로 실무에 바로 적용 가능한 생산성 솔루션을 만들어보세요.',
        teamPolicy: { allowSolo: true, maxTeamSize: 3 },
      },
      info: { notice: ['비개발자 적극 환영', '상용 노코드/로우코드 툴 모두 허용', '실무 적용 사례 중심 평가'], links: { rules: '#', faq: '#' } },
      eval: { metricName: '업무 자동화', description: '실무 적용 가능성과 생산성 향상 효과를 중심으로 평가합니다.', scoreSource: 'auto' },
      schedule: {
        timezone: 'Asia/Seoul',
        milestones: [
          { name: '대회 시작 및 팀 모집', at: '2026-05-01T10:00:00+09:00', step: 0 },
          { name: '1단계: 업무 자동화 시나리오 기획서', at: '2026-05-10T23:59:59+09:00', type: 'submission', step: 1, itemKey: 'scenario', galleryEnabled: false },
          { name: '2단계: 최종 솔루션 데모 제출', at: '2026-05-18T23:59:59+09:00', type: 'submission', step: 2, itemKey: 'demo', galleryEnabled: false },
          { name: '솔루션 공개 및 투표', at: '2026-05-19T10:00:00+09:00', type: 'voting', step: 3, votingEnabled: true, galleryEnabled: true },
          { name: '최종 결과 발표', at: '2026-05-25T14:00:00+09:00', type: 'result', step: 4 },
        ],
      },
      ...
      submit: {
        allowedArtifactTypes: ['url', 'pdf'],
        submissionUrl: '#',
        guide: ['시나리오 기획서와 솔루션 데모 링크를 단계별로 제출하세요.'],
        submissionItems: [
          { key: 'scenario', title: '업무 자동화 시나리오 기획서 (PDF)', format: 'PDF', deadline: '2026-05-10T23:59:59+09:00' },
          { key: 'demo', title: '노코드 솔루션 데모 링크', format: 'URL', deadline: '2026-05-18T23:59:59+09:00', isGalleryTarget: true },
        ],
      },
      leaderboard: { publicLeaderboardUrl: '#', note: '투표 결과 30% + 심사위원 점수 70%로 최종 순위를 결정합니다.' },
    },
  },
  {
    slug: 'gamification-startup-2026',
    ...
    sections: {
      overview: {
        summary: '게임 메커닉을 활용한 스타트업 비즈니스 모델을 기획하는 아이디어톤입니다. 포인트, 뱃지, 리더보드 등 게임화 요소로 사용자 참여를 극대화하는 혁신 서비스를 기획하세요.',
        teamPolicy: { allowSolo: true, maxTeamSize: 5 },
      },
      info: { notice: ['신규 비즈니스 모델 제안 필수', '게임화 설계 요소(포인트/뱃지/리더보드 등) 포함 필수', '최종 발표 심사 있음'], links: { rules: '#', faq: '#' } },
      eval: { metricName: '재미와 보상', description: '게이미피케이션 설계의 창의성과 사업 실현 가능성을 종합 평가합니다.', scoreSource: 'auto' },
      schedule: {
        timezone: 'Asia/Seoul',
        milestones: [
          { name: '대회 시작 및 팀 모집', at: '2026-05-20T10:00:00+09:00', step: 0 },
          { name: '1단계: 게임화 아이디어 기획서 제출', at: '2026-06-01T23:59:59+09:00', type: 'submission', step: 1, itemKey: 'idea', galleryEnabled: false },
          { name: '2단계: 발표 자료(PPT/PDF) 제출', at: '2026-06-07T23:59:59+09:00', type: 'submission', step: 2, itemKey: 'deck', galleryEnabled: false },
          { name: '최종 발표 심사 및 결과', at: '2026-06-10T15:00:00+09:00', type: 'result', step: 3 },
        ],
      },
      prize: { items: [{ place: '1등', amountKRW: 2500000 }, { place: '2등', amountKRW: 1500000 }, { place: '3등', amountKRW: 1000000 }] },
      teams: { campEnabled: true, listUrl: '#' },
      submit: {
        ...
        submissionUrl: '#',
        guide: ['아이디어 기획서와 발표 자료를 단계별로 제출하세요.'],
        submissionItems: [
          { key: 'idea', title: '게임화 아이디어 기획서 (PDF)', format: 'PDF', deadline: '2026-06-01T23:59:59+09:00' },
          { key: 'deck', title: '발표 자료 PPT/PDF', format: 'PDF', deadline: '2026-06-07T23:59:59+09:00', isGalleryTarget: true },
        ],
      },
      leaderboard: { publicLeaderboardUrl: '#', note: '심사위원 점수를 기반으로 최종 순위가 결정됩니다.' },
    },
  },
  {
    slug: 'green-tech-zero-waste',
    ...
    sections: {
      overview: {
        summary: '탄소 중립과 제로 웨이스트를 실현하는 그린테크 솔루션 해커톤입니다. 환경 데이터 분석부터 실제 앱·서비스 프로토타입까지 구현해 지구 환경에 기여하는 솔루션을 만들어보세요.',
        teamPolicy: { allowSolo: true, maxTeamSize: 4 },
      },
      info: { notice: ['ESG 가치 중심 평가', '실제 환경 데이터 활용 권장', '최종 제출은 오픈소스로 공개'], links: { rules: '#', faq: '#' } },
      eval: { metricName: '탄소 배출 저감', description: '환경 영향력과 솔루션의 실현 가능성, 확장성을 종합 평가합니다.', scoreSource: 'auto' },
      schedule: {
        timezone: 'Asia/Seoul',
        milestones: [
          { name: '대회 시작 및 팀 모집', at: '2026-06-01T10:00:00+09:00', step: 0 },
          { name: '1단계: 환경 문제 분석 보고서 제출', at: '2026-06-15T23:59:59+09:00', type: 'submission', step: 1, itemKey: 'report', galleryEnabled: false },
          { name: '2단계: 그린테크 솔루션 데모 제출', at: '2026-06-22T23:59:59+09:00', type: 'submission', step: 2, itemKey: 'demo', galleryEnabled: false },
          { name: '대국민 공개 투표', at: '2026-06-23T10:00:00+09:00', type: 'voting', step: 3, votingEnabled: true, galleryEnabled: true },
          { name: '최종 결과 발표', at: '2026-06-30T18:00:00+09:00', type: 'result', step: 4 },
        ],
      },
      ...
      submit: {
        allowedArtifactTypes: ['url', 'pdf'],
        submissionUrl: '#',
        guide: ['환경 문제 분석 보고서와 솔루션 데모를 단계별로 제출하세요.'],
        submissionItems: [
          { key: 'report', title: '환경 문제 분석 보고서 (PDF)', format: 'PDF', deadline: '2026-06-15T23:59:59+09:00' },
          { key: 'demo', title: '그린테크 솔루션 데모 링크', format: 'URL', deadline: '2026-06-22T23:59:59+09:00', isGalleryTarget: true },
        ],
      },
      leaderboard: { publicLeaderboardUrl: '#', note: '대국민 투표 30% + 심사위원 점수 70%로 최종 순위를 결정합니다.' },
    },
  },
...
export const currentUser: CurrentUser = {
  ...
  skills: ['Figma', 'Notion', 'PRD작성', 'VibeCoding', 'PM', 'UX라이팅', '시장조사', '교육', '바이브코딩'],
