...
export const leaderboards: Record<string, Leaderboard> = {
  ...
  'cloud-native-modernization': {
    updatedAt: new Date().toISOString(),
    entries: [
      { rank: null, teamName: 'Cloud Runners', score: null, votes: 280, submittedAt: '2026-03-30T10:00:00Z' },
      { rank: null, teamName: 'Deploy Fast', score: null, votes: 220, submittedAt: '2026-03-30T10:00:00Z' },
      { rank: null, teamName: 'Zero Latency', score: null, votes: 190, submittedAt: '2026-03-30T10:00:00Z' },
      ...Array.from({ length: 22 }).map((_, i) => ({
        rank: null,
        teamName: teamNameLibrary[(i + 3) % teamNameLibrary.length] + ` #${i + 1}`,
        score: null,
        votes: Math.max(10, 180 - i * 7),
        submittedAt: i < 18 ? '2026-03-30T10:00:00Z' : null,
      })),
    ],
  },
  'ux-ui-redesign-2026': {
