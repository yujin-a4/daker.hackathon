...
export const teams: Team[] = [
  {
    ...
    memberIds: ['user-002-model', 'user-101', 'user-102'], // 시드 데이터에 맞게 3명
    applicantIds: [],
    memberCount: 3,
    maxTeamSize: 5,
  ...
  // --- daker-handover-2026-03 (41 entries: 26 Teams + 15 Solos) ---
  {
    ...
    memberIds: ['user-001-yujin', 'user-103', 'user-104'], // 시드 데이터에 맞게 3명
    applicantIds: [],
    memberCount: 3,
    maxTeamSize: 5,
  ...
  ...[
    ...
    memberIds: [`user-team-leader-${i}`], // 실제 구현시에는 memberCount만큼 더미 ID를 채울 수도 있음
    applicantIds: [],
    memberCount: (i % 4) + 2,
    maxTeamSize: 5,
    lookingFor: [],
